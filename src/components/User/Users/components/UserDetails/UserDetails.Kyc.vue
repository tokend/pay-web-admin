    ...
    <template v-if="isLoaded">
      ...
      <ul class="key-value-list">
        <li>
          ...
          <span :title="kyc.selfDescription">{{ kyc.selfDescription }}</span>
        </li>
        <li>
        ...
        <li>
          ...
          <span :title="kyc.phoneNumber">{{ kyc.phoneNumber }}</span>
        </li>
        <li>
        ...
        <li>
          ...
          <span :title="kyc.idExpirationDate">{{ kyc.idExpirationDate }}</span>
        </li>
        <li>
          <span>Id series and number</span>
          <span :title="kyc.idSeries">{{ kyc.idSeries }}</span>
        </li>
        <li>
          <span>Country of citizenship</span>
          <span :title="kyc.citizenship">{{ kyc.citizenship }}</span>
        </li>
        <li>
